...
public class PassiveReferenceTest {
  ...
  public static class SuperClass {
    ...
    static {
      LLogger.d("SuperClass.static initializer");
    }
  ...
  public static class SubClass extends SuperClass {
    ...
    static {
      LLogger.d("SubClass.static initializer");
    }
  }
...
//    LLogger.d(classes.getClass());

    /**
     * final静态字段 在编译阶段会存入类的常量池中（甚至传播优化出去），在编译阶段和类断开联系
     */
    LLogger.d(SuperClass.final_value);
  }
}
