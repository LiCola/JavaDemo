...
//        testOperate();
  ...
  private static void testHeightOperate() {
    ...
    System.out.println("highestOneBit:" + result1);

    int data1 = -2;
    int data2 = 7;
    String bitData1 = Integer.toBinaryString(data1);
    String bitData2 = Integer.toBinaryString(data2);
    System.out.println("data1:" + data1 + " bit:" + bitData1);
    System.out.println("data2:" + data2 + " bit:" + bitData2);
...
//        Integer v1=40;
//        Integer v2=40;
//        System.out.println(v1==v2);//输入 true
//
//        Integer v3=128;
//        Integer v4=128;
